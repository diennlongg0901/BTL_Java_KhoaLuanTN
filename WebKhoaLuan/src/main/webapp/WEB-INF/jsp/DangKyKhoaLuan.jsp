                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <c:forEach items="${dsdangkykhoaluan}" var="dkkl">
                                <tr>
                                    <td>${dkkl.dangkykhoaluanPK.sinhvienmaSV}</td>
    ...
    <div class="form-group container-fluid">
        <div class="row">
            <div class="form-outline mt-4 col">
                <form:input type="text" id="maSV" path="dangkykhoaluanPK.sinhvienmaSV" class="form-control" value="${nguoidung.nguoidungPK.maND}" placeholder="Nhập mã sinh viên"/>
            </div>
            <div class="form-outline mt-4 col">
